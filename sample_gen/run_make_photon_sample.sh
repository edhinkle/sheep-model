...
OUTPUT=$1
NEVENTS=$2
EDEP_MACRO="photon_sim"
#OUTDIR="/pscratch/sd/e/ehinkle/nd_ana/sheep_single_shower/PHOTON_SAMPLES"
...
./make_edep_sim_photon_sample.sh ${GEOMETRY} ${OUTPUT} ${NEVENTS} ${EDEP_MACRO} ${OUTDIR} ${INDIR} ${FILE_INDEX}
EOF1