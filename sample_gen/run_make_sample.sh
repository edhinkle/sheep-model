...
OUTDIR="/global/cfs/cdirs/dune/users/ehinkle/nd_prototypes_ana/sheep-model/sample_gen"
FILE_INDEX=$3
...
./make_edep_sim_sample.sh ${GEOMETRY} ${OUTPUT} ${NEVENTS} ${EDEP_MACRO} ${OUTDIR} ${FILE_INDEX}
EOF1