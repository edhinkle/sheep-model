# Modeled after: https://github.com/NERSC/nersc-dl-multigpu/blob/main/train_single_gpu.py
...
class Trainer():
    ...
    # Initialize experiment directory (where checkpoints and logs will be saved)
    ...
    def launch(self):
        ...
        #self.test_data_loader, self.test_sampler = get_data_loader(self.params, self.params.test_path, False, train=False)
