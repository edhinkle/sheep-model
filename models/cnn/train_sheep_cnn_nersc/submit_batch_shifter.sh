...
#SBATCH --job-name=sheep-dl-500k-mse-lin-2x2Electrons-VEFracTarget-WD1e-4
...
config="l1_lin"
run_num="L1-LinEnergyScale-500kSample-2x2Electrons-3200bs-1000vbs-VEFracTarget-WD1e-4"
